...
/**
 * Validator for the {@link ValidSalesStartTime} annotation when used with SessionTimeUpdateDTO.
 * Validates that the sales start time is before the session start time.
 */
public class SessionTimeUpdateValidator implements ConstraintValidator<ValidSalesStartTime, SessionTimeUpdateDTO> {
